...
-- Telescope
----------------------------------------------------------------------
-- as.map("", "<M-d>", ":Telescope file_browser<CR>")
-- as.map("", "<C-p>", ":Telescope find_files<CR>")
-- as.map("", "<leader>b", ":Telescope buffers<CR>", { silent = false })

as.map("", "<M-d>", ":Telescope file_browser<CR>")
as.map("", "<leader>td", ":Telescope file_browser<CR>")
as.map("", "<leader>tf", ":Telescope find_files<CR>")
as.map("", "<leader>tb", ":Telescope buffers<CR>", { silent = false })
