...
(require 'package)
(setq package-enable-at-startup nil) ;;; Without this line, (package-initialize) is executed twice. Once during evaluation of this file, and another after Emacs finishes reading the init file.
...
;;; Not sure when to use this setting
